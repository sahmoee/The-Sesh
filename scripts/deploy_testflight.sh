...
repo_dir="${0:A:h:h}"
project="${repo_dir}/The SESH..xcodeproj"
scheme="The SESH."
...
archive="${archive_root}/The-SESH-b${next}-${stamp}.xcarchive"
...
print "Uploaded The SESH. build ${next} to App Store Connect/TestFlight."
